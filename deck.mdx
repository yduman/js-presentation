...
- [GitHub Repository](https://github.com/kentcdodds/react-testing-library)
...
- build your Frontend with `yarn build`
- move built files to the `public` folder of your Backend
- add `app.use(express.static('public'))` to your `server.js`
